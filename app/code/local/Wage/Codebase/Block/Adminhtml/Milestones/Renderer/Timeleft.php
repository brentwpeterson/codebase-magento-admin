<?php
class Wage_Codebase_Block_Adminhtml_Milestones_Renderer_Timeleft extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
	...
	$estimatedTime = $row->getData($this->getColumn()->getIndex());
...
$newcollection->getSelect()
	...
	{
		return $estimatedTime - $item['total_spent_time'];
	}       
    }
}
